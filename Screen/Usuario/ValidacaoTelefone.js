  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.tempoTxt}>
        Para sua segurança, este código tem um tempo para o reenvio 04:37
        restantes
      </Text>
      ...
      <TouchableOpacity
        style={styles.enviarNovamenteBtn}
        onPress={() => setModalVisible(true)}
      >
        <Text style={styles.enviarBtnTxt}>Enviar novamente</Text>
      </TouchableOpacity>
      ...
      >
        <View style={styles.modalContainer}>
          <View style={styles.modalView}>
            ...
            <Text style={styles.reenvioTxt}>
              Reenviamos um código de confirmação via SMS para o número
              cadastrado.
            </Text>
            <TouchableOpacity
