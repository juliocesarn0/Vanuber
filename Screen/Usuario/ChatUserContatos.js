    ...
    <View style={styles.container}>
      <View style={styles.content}>
        ...
        >
          ...
          />
          <Text style={styles.nomeContato}>Júlio César</Text>
        ...
        >
          ...
          />
          <Text style={styles.nomeContato3}>Gabriela Sígolo</Text>
        ...
        >
          <Image
            ...
            style={styles.iconContato3}
          />
          <Text style={styles.nomeContato4}>Júlio César</Text>
          <Text style={styles.mensagem4}>Olá, boa tarde!</Text>
          <Text style={styles.hora4}>6:10 PM</Text>
        </TouchableOpacity>
        ...
        >
          <Image
            ...
            style={styles.iconContato3}
          />
          <Text style={styles.nomeContato5}>Grazielle</Text>
          <Text style={styles.mensagem5}>Olá, boa tarde!</Text>
          <Text style={styles.hora5}>11:10 PM</Text>
        </TouchableOpacity>
      </View>
...
export default ChatUserContatos;
